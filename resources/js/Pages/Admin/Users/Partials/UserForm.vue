...
<template>
    ...
    -->
        <div class="mb-4">
            ...
            <Password v-model="form.password" class="w-full" :feedback="false" toggle-mask />
    ...
    -->
        <div class="mb-6">
            ...
            />
            <small v-if="form.errors.role" class="text-red-500 mt-1 block">{{
                form.errors.role
            }}</small>
        </div>

        <Button label="Save User" icon="pi pi-check" :loading="form.processing" @click="submit" />
    </div>
</template>
