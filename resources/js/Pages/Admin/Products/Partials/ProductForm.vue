...
<div class="card bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    ...
    <div class="mb-4">
        ...
        <small v-if="form.errors.title" class="text-red-500 mt-1 block">{{ form.errors.title }}</small>
    </div>
    ...
    <div class="mb-4">
        <label class="block mb-2 font-medium text-gray-700 dark:text-gray-200">
            Slug <span class="text-gray-400 text-sm font-normal">(auto-generated if blank)</span>
        </label>
        <InputText v-model="form.slug" class="w-full" placeholder="e.g. iphone-15-pro-max" />
        <small v-if="form.errors.slug" class="text-red-500 mt-1 block">{{ form.errors.slug }}</small>
    </div>
    ...
    <div class="mb-4">
        ...
        <Select
            ...
            class="w-full"
        />
        <small v-if="form.errors.category_id" class="text-red-500 mt-1 block">{{ form.errors.category_id }}</small>
    </div>
    ...
    <div class="flex gap-4 mb-4">
        ...
        <div class="flex-1">
            ...
            <small v-if="form.errors.quantity" class="text-red-500 mt-1 block">{{ form.errors.quantity }}</small>
        </div>
        ...
        <div class="flex-1">
            ...
            <small v-if="form.errors.in_stock" class="text-red-500 mt-1 block">{{ form.errors.in_stock }}</small>
        </div>
        ...
        <div class="flex-1">
            ...
            <small v-if="form.errors.price" class="text-red-500 mt-1 block">{{ form.errors.price }}</small>
        </div>
        ...
        <div class="flex-1">
            <InputGroup>
                ...
                <InputNumber v-model="form.discount_price" :min="0" :minFractionDigits="2" :maxFractionDigits="2" />
            </InputGroup>
            <small v-if="form.errors.discount_price" class="text-red-500 mt-1 block">{{ form.errors.discount_price }}</small>
        </div>
    ...
    <div class="mb-4">
        ...
        <Editor v-model="form.description" editorStyle="height: 200px" class="w-full" />
    </div>
    ...
    <div class="mb-4">
        ...
        <div v-if="preview" class="mt-3">
            <img :src="preview" class="h-32 rounded shadow object-cover" alt="Product preview" />
        </div>
        <small v-if="form.errors.image" class="text-red-500 mt-1 block">{{ form.errors.image }}</small>
    </div>
