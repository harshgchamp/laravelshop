...
<AdminLayout>
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ props.users }}</p>
                </div>
                <!-- Icon badge: blue circle with users icon -->
                <div class="flex items-center justify-center w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-400/10">
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex justify-between items-center">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Categories</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ props.categories }}</p>
                </div>
                <div class="flex items-center justify-center w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-400/10">
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-4">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ props.products }}</p>
                </div>
                <div class="flex items-center justify-center w-12 h-12 rounded-full bg-cyan-100 dark:bg-cyan-400/10">
