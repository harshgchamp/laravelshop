          ...
          <div class="flex border-b py-5">
            <div class="flex w-full">
              <div class="flex flex-col gap-2">
                <Link :href="route('account.orders.index')" class="flex items-center gap-2 font-medium text-violet-900">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
        ...
        >
          <table class="table-fixed">
            ...
            <tbody> 
              ...
              <tr class="border-b"  v-for="order in orders.data" :key="order.id" > 
                ...
                <td class="mx-auto text-center">{{ new Date(order.created_at).toLocaleDateString() }}</td>
                ...
                <td class="text-center align-middle">
                  <Link :href="`/account/orders/${order.id}`" class="bg-amber-400 px-4 py-2"
