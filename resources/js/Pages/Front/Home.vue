...
import CategoryGrid from '@/Pages/Front/Components/Category/CategoryGrid.vue';
...
<template>
    <FrontLayout>
        ...
        <CategoryGrid :categories="props.categories.data" />

        <!-- /Categories  -->

        <!-- Products -->
        <h2 class="mx-auto mt-10 mb-5 max-w-[1200px] px-5">TOP NEW ARRIVAL</h2>
        <section class="mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4">
            <ProductGrid :products="props.products.data" />
        </section>
        <!-- /Products  -->
    </FrontLayout>
</template>
